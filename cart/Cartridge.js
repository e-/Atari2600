function Cartridge() /* implements IfcDevice */
{
    ...
    this.getMD5 = function(){ return myMD5; };
    this.setMD5 = function(String aMD5){ myMD5=aMD5; };
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    this.create = function(image){
        var zMD5 = calculateMD5(image); //Calculate the MD5 based on the byte array
        console.log("LOADING ROM : " + zMD5);
       
        cartridge = null;
        
        zType=detectTypeByMD5(zMD5);
        ...
        cartridge=create2(image, zType); /* create2 -> has tow args. because javascript does not support overloading */
   	...
   	this.create2 = function(image,aType){ /* original name of this function is "create", but javascript does not support function overloading */
        ...
        zIntImage=toIntArray(image); //create an int array from the byte array
        if(zUCType === TYPE_2K.toUpperCase()) cartridge = new Cartridge2K(zIntImage);
        else if(zUCType===TYPE_4K.toUpperCase())) cartridge = new Cartridge4K(zIntImage);
        ...
        zMD5 = calculateMD5(image); //Calculate the MD5 based on the byte array 
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   ...
   // ============== Subclass convenience methods =====================
    ...
    this.randomizeRAM = function(int[] aRAM)
    {
    ...
    this.addDirectPokeAccess(aStartAddress, aEndAddress,aMemory, aBaseAddressMask)
     {
